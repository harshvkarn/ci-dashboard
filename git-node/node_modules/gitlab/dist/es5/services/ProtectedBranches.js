...
function (_BaseService) {
  ...
  function ProtectedBranches() {
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(ProtectedBranches).apply(this, arguments));
  }
  ...
  (0, _createClass2.default)(ProtectedBranches, [{
    ...
    value: function show(projectId, branchName) {
      var _map = [projectId, branchName].map(encodeURIComponent),
          _map2 = (0, _slicedToArray2.default)(_map, 2),
          pId = _map2[0],
          bName = _map2[1];

      return _infrastructure.RequestHelper.get(this, "projects/".concat(pId, "/protected_branches/").concat(bName));
    }
  }, {
    key: "unprotect",
    value: function unprotect(projectId, branchName) {
      var _map3 = [projectId, branchName].map(encodeURIComponent),
          _map4 = (0, _slicedToArray2.default)(_map3, 2),
          pId = _map4[0],
          bName = _map4[1];

      return _infrastructure.RequestHelper.delete(this, "projects/".concat(pId, "/protected_branches/").concat(bName));
    }
  }]);
