...
var url = function url(userId) {
  return userId ? "users/".concat(encodeURIComponent(userId), "/emails") : 'user/emails';
};
...
function (_BaseService) {
  ...
  function UserEmails() {
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(UserEmails).apply(this, arguments));
  }
  ...
  (0, _createClass2.default)(UserEmails, [{
    ...
    value: function show(emailId) {
      ...
      return _infrastructure.RequestHelper.get(this, "user/emails/".concat(eId));
    }
  }, {
    key: "remove",
    value: function remove(emailId) {
      ...
      var eId = encodeURIComponent(emailId);
      return _infrastructure.RequestHelper.delete(this, "".concat(url(userId), "/").concat(eId));
    }
  }]);
  return UserEmails;
