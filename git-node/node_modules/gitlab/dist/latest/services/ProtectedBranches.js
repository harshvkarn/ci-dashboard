...
class ProtectedBranches extends _infrastructure.BaseService {
  ...
  show(projectId, branchName) {
    ...
    return _infrastructure.RequestHelper.get(this, `projects/${pId}/protected_branches/${bName}`);
  }

  unprotect(projectId, branchName) {
    const [pId, bName] = [projectId, branchName].map(encodeURIComponent);
    return _infrastructure.RequestHelper.delete(this, `projects/${pId}/protected_branches/${bName}`);
  }
