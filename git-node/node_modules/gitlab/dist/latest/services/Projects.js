...
class Projects extends _infrastructure.BaseService {
  ...
  languages(projectId) {
    const pId = encodeURIComponent(projectId);
    return _infrastructure.RequestHelper.get(this, `projects/${pId}/languages`);
  }

  mirrorPull(projectId) {
    const pId = encodeURIComponent(projectId);
    return _infrastructure.RequestHelper.post(this, `projects/${pId}/mirror/pull`);
  }
  ...
  show(projectId, options) {
    const pId = encodeURIComponent(projectId);
    return _infrastructure.RequestHelper.get(this, `projects/${pId}`, options);
  }
